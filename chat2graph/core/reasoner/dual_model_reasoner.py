...
from chat2graph.core.prompt.model_service import TASK_DESCRIPTOR_PROMPT_TEMPLATE
from chat2graph.core.prompt.reasoner import ACTOR_PROMPT_TEMPLATE, META_THINKER_PROMPT_TEMPLATE
